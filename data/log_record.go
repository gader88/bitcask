...
// EncodeLogRecordPos 对位置信息编码
func EncodeLogRecordPos(pos *LogRecordsPos) []byte {
...
func DecodeLogRecordPos(buf []byte) *LogRecordsPos {
	var index = 0
	...
	return &LogRecordsPos{Fid: uint32(fileID), Offset: offset, Size: uint32(size)}
}
